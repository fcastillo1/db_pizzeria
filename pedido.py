...
class insertar_pedido:
    ...
    def __config_label(self):
        ...
        fecha_pedido_lab.place(x = 10, y = 70, width = 120, height = 20)
        fecha_reparto_lab = tk.Label(self.insert_datos, text = "Fecha Reparto: ")
        fecha_reparto_lab.place(x = 10, y = 100, width = 120, height = 20)
        cliente_lab = tk.Label(self.insert_datos, text = "RUT cliente: ")
        cliente_lab.place(x = 10, y = 40, width = 120, height = 20)
        repartidor_lab = tk.Label(self.insert_datos, text = "RUT repartidor:" )
        repartidor_lab.place(x = 10, y = 70, width = 120, height = 20)
        vehiculo_lab = tk.Label(self.insert_datos, text = "ID VEHICULO: ")
        vehiculo_lab.place(x = 10, y = 100, width = 120, height = 20)
    ...
    def __insertar(self):
        ...
        "cliente": self.ids[self.combo1.current()], "repartidor": self.ids[self.combo2.current()],
        "vehiculo": self.ids[self.combo3.current()]})
